...
local Themes = {
    ...
    ["Default"] = {
        Topbar = Color3.fromRGB(31, 31, 43),
        TabContainer = Color3.fromRGB(31, 31, 43),
        Lines = Color3.fromRGB(44, 53, 67),
        HoverTabFrame = Color3.fromRGB(41, 49, 65),
        ItemUIStroke = Color3.fromRGB(31, 31, 43),
        TabFrame = Color3.fromRGB(31, 31, 43),
        SectionFrame = Color3.fromRGB(25, 25, 33),
        TabText = Color3.fromRGB(255, 255, 255),
        ItemText = Color3.fromRGB(237, 237, 237),
        SectionText = Color3.fromRGB(237, 237, 237),
        ItemUIStrokeSelected = Color3.fromRGB(31, 31, 43),
        SelectedTabFrame = Color3.fromRGB(8, 242, 155),
        ItemFrame = Color3.fromRGB(31, 31, 43),
        HoverItemFrame = Color3.fromRGB(43, 50, 67),
        DropdownIcon = Color3.fromRGB(175, 175, 175),
        SectionUIStroke = Color3.fromRGB(31, 31, 43),
        ...
        SliderInner = Color3.fromRGB(8, 242, 155),
        TabUIStroke = Color3.fromRGB(31, 31, 43),
        ToggleOuter = Color3.fromRGB(48, 56, 75),
        ToggleOuterEnabled = Color3.fromRGB(8, 242, 155),
        ToggleOuterUIStroke = Color3.fromRGB(42, 49, 65),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(8, 242, 155),
        ToggleInner = Color3.fromRGB(77, 90, 121),
        ToggleInnerEnabled = Color3.fromRGB(48, 56, 75),
        ContainerHolder = Color3.fromRGB(25, 32, 43),
        HighlightUIStroke = Color3.fromRGB(31, 31, 43),
        Highlight = Color3.fromRGB(5, 5, 5)
    }
}
...
if not isfolder("Hellcat") then
makefolder("Hellcat")

local Logo = request({Url = "https://raw.githubusercontent.com/NightCoded/Hellcat/main/assets/Logo.png", Method = "GET"})
writefile("Hellcat/Logo.png", Logo.Body)

local Open = request({Url = "https://raw.githubusercontent.com/NightCoded/Hellcat/main/assets/Open.png", Method = "GET"})
writefile("Hellcat/Open.png", Open.Body)

local Chevron = request({Url = "https://raw.githubusercontent.com/NightCoded/Hellcat/main/assets/Chevron.png", Method = "GET"})
writefile("Hellcat/Chevron.png", Chevron.Body)

local Circle = request({Url = "https://raw.githubusercontent.com/NightCoded/Hellcat/main/assets/Circle.png", Method = "GET"})
writefile("Hellcat/Circle.png", Circle.Body)
end
...
notificationTime.Font = Enum.Font.SourceSans
...
Hellcat.Name = HttpService:GenerateGUID(true)
...
imageLogo.Image = getcustomasset("Hellcat/Logo.png")
...
minimizeButton.MouseButton1Click:Connect(function()
    ...
    if Minimized then
        ...
        topbar.Size = UDim2.new(0, 34, 0, 34)
        uICorner.CornerRadius = UDim.new(0, 90)
        uICorner1.CornerRadius = UDim.new(0, 90)
        imageLogo.Visible = false
        minimizeButton.Position = UDim2.new(0.776, -18, 0.261, 0)
        minimizeButton.Image = getcustomasset("Hellcat/Open.png")
        minimizeButton.ImageColor3 = Theme.ItemText
        minimizeButton.Size = UDim2.new(0, 18, 0, 18)
        minimizeButton.ImageTransparency = 0
        
        end
    TweenService:Create(main, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Size = Minimized and UDim2.new(0, 34,0, 34) or UDim2.new(0, 500,0, 350)}):Play()
...
sectionIcon.Image = getcustomasset("Hellcat/Chevron.png")
...
keybindOuterText.Font = Enum.Font.SourceSans
...
dragIcon.Image = getcustomasset("Hellcat/Circle.png")
...
dropdownIcon.Image = getcustomasset("Hellcat/Chevron.png")
...
toggleInner.Image = getcustomasset("Hellcat/Circle.png")
...
function tabtable:Textview(Info)
...
sectionLabel.Size = UDim2.new(0, 500, 0, 300)
...
sectionLabelFrame.Size = UDim2.new(0, 364, 0, 28)
...
sectionLabelName.Size = UDim2.new(0, 138, 0, 28)
...
sectionLabelButton.Size = UDim2.new(0, 364, 0, 28)
sectionLabelButton.Parent = sectionLabelFrame
sectionLabelButton.ZIndex = Sections + 1

local sectionLabelIcon = Instance.new("ImageLabel")
sectionLabelIcon.Name = "SectionIcon"
sectionLabelIcon.Image = getcustomasset("Hellcat/Chevron.png")
sectionLabelIcon.ImageColor3 = Theme.SectionText
sectionLabelIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
sectionLabelIcon.BackgroundTransparency = 1
sectionLabelIcon.Position = UDim2.new(0, 155, 0, 5)
sectionLabelIcon.Rotation = 90
sectionLabelIcon.Selectable = false
sectionLabelIcon.Size = UDim2.new(0, 17, 0, 17)
sectionLabelIcon.Parent = sectionLabelFrame
sectionLabelIcon.ZIndex = Sections + 2
...
containerLabelHolder.Size = UDim2.new(0, 364, 0, 0)
...
itemLabelContainer.Size = UDim2.new(0, 350, 0, 0)
